...
export default function ProvidersDirectoryFallback() {
              ...
              <tbody className="bg-white">
                {Array.from({ length: 50 }).map((_, index) => (
                  <tr className="border-[#ebebeb] border-t" key={index}>
                    ...
                    <td className="px-4 h-10 text-left">
                      <div className="flex items-center">
                        <div className="bg-[linear-gradient(270deg,_#fafafa,_#eaeaea,_#eaeaea,_#fafafa)] bg-[length:400%_100%] rounded-md w-20 h-5 animate-skeleton"></div>
                      </div>
                    </td>
                    <td className="px-4 h-10 text-left">
                      <div className="flex items-center">
